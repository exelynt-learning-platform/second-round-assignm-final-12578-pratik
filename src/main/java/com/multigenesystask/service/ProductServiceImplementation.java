...
public class ProductServiceImplementation implements ProductService {
	...
	public Page<Product> getAllProduct(String category, List<String> colors, List<String> sizes, Integer minPrice,
		...
		if (colors.isEmpty()) {
			Set<String> colorSet = colors.stream().map(String::toLowerCase).collect(Collectors.toSet());

			products = products.stream().filter(p -> colorSet.contains(p.getColor().toLowerCase()))
